...
define("_NICKNAME","SL Firstname");
define("_LASTNAME","SL Lastname");
...
define("_ASREGISTERED","Don't have an account yet? You can <a href=\"index.php?name=Your_Account&amp;op=new_user\">create one</a>. As a registered user you have some advantages like theme manager, comments configuration and post comments with your name.");
...
define("_YOUAREANON","You are Anonymous user. You can register for free by clicking <a href=\"index.php?name=Your_Account&amp;op=new_user\">here</a>");
define("_NOTE","Note:");
define("_ADMIN","Admin:");
...
define("_MODULEUSERS", "We are Sorry, but this section of our site is for <i>Registered Users Only.</i><br><br>You can register for free by clicking <a href=\"index.php?name=Your_Account&op=new_user\">here</a>, then you can<br>access this section without restrictions. Thanks.<br><br>");
