...
//get_writable_cell
function get_writable_cell( $folder ) {
	echo '<tr>';
...
could lead to your Skidz Partz - Exchange installation not functioning
correctly.
<div class="ctr"></div>
</div>
...
compatibility with Skidz Partz - Exchange.
<br />
However, Skidz Partz - Exchange will still operate if your settings do not quite match the recommended
<div class="ctr"></div>
</div>
...
<table class="content">
<?php
get_writable_cell('config.php');
get_writable_cell('modules/Marketplace/images');
?>
</table>
</div>
<div class="clr"></div>
