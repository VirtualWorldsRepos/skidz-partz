		...
		<div id="right">
			<div class="far-right">
	  		...
	  		<div class="install-text">
  				<p>Setting up Skidz Partz - Exchange to run on your server involves 4 simple steps...</p>
  				<p>Please enter the hostname of the server Skidz Partz - Exchange is to be installed on.</p>
				<p>Enter the MySQL username, password and database name you wish to use with Skidz Partz - Exchange.</p>
			...
			<div class="install-form">
  				<div class="form-block">
					...
					<tr>
			  			...
			  			<td>
			  				<em>Either something as 'root' or a username given by the Hosting company</em>
			  			</td>
  					</tr>
			  		<tr>
			  			<td colspan="2">
  		  			...
  		  			<tr>
			  			...
			  			<td>
			  				<em>Set the database name for your new Skidz Partz - Exchange powered site.</em>
			  			</td>
  					</tr>
		  		 	</table>
