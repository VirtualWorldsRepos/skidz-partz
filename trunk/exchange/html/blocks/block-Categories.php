...
global $cat, $language, $prefix, $multilingual, $currentlang, $db;
	...
	while ($row = $db->sql_fetchrow($result)) {
		...
		if ($cat == 0 AND !$a) {
		    ...
		    $boxstuff .= "<strong><big>&middot;</big></strong>&nbsp;<a href=\"index.php?name=News\">"._ALLCATEGORIES."</a><br>";
		    $a = 1;
		}
		...
		if ($cat == $catid) {
		    ...
		    $boxstuff .= "<strong><big>&middot;</big></strong>&nbsp;<a href=\"index.php?name=News&amp;file=categories&amp;op=newindex&amp;catid=$catid\">$title</a><br>";
		}
	    }
	}
	$boxstuff .= "</span>";
