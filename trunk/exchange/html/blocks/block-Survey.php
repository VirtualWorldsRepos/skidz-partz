...
if ($pollID == 0 || empty($pollID)) {
	...
	$content .= "<form action=\"index.php?name=Surveys\" method=\"post\">";
    ...
    // Quake - end
	$content .= "<br><span class=\"content\"><a href=\"index.php?name=Surveys&amp;op=results&amp;pollID=".$pollID.$r_options."\"><strong>"._RESULTS."</strong></a><br><a href=\"index.php?name=Surveys\"><strong>"._POLLS."</strong></a><br>";
	if ($pollcomm) {
