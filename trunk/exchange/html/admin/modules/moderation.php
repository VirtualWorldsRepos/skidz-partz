...
if ($row['radminsuper'] == 1) {
	...
	function moderation_news() {
		...
		while ($row = $db->sql_fetchrow($sql)) {
			...
			echo "<td bgcolor=\"$bgcolor1\">&nbsp;<a href=\"index.php?name=Your_Account&op=userinfo&username=".$row['name']."\" target=\"_blank\">".$row['name']."</a>&nbsp;</td>";
	...
	function moderation_reviews() {
		...
		while ($row = $db->sql_fetchrow($sql)) {
			...
			echo "<td bgcolor=\"$bgcolor1\">&nbsp;<a href=\"index.php?name=Your_Account&op=userinfo&username=$row[userid]\" target=\"_blank\">$row[userid]</a>&nbsp;</td>";
	...
	function moderation_users_list($section=0) {
		...
		while($row = $db->sql_fetchrow($sql)) {
			echo "<tr><td bgcolor=\"$bgcolor1\">&nbsp;<a href=\"index.php?name=Your_Account&op=userinfo&username=".$row['username']."\" target=\"_blank\">".$row['username']."</a>&nbsp;</td>";
