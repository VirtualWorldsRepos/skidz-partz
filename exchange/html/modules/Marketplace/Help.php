...
function index()
{
		...
		//options_menu("footer");
		Open_Table();
		$row = $db->sql_fetchrow($db->sql_query("SELECT message2  from ".$prefix."_marketplace_messages"));
		$help = filter($row['message2'], "nohtml", 1);
		echo "<center><font class='option'><b>"._HELP_MSG."</b></font></center>"
			."<table border=\"0\" align=\"center\" cellpadding=\"3\"><tr><td>"
			."&nbsp;</td><td>" . stripslashes($help) . ""
