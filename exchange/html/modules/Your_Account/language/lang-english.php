...
define("_CHANGEYOURINFO","Settings");
define("_YOURFUNDS","Funds");
define("_YOURSUBSCRIPTIONS","Subscriptions");
define("_YOUREXCHANGE","Exchange");
define("_YOURITEMS","Items");
define("_YOURINVENTORY","Inventory");
define("_YOURPURCHASES","Purchases");
define("_YOURSALES","Sales");
define("_YOURTRAFFIC","Traffic");
//define("_YOURANSPREFERENCES","My ANS Preferences");
define("_YOURESTATE","Estate");
...
define("_YOUCANLOGIN","In a few seconds you'll receive an email from our system with your assigned password. Then you can login <a href=\"index.php?name=Your_Account\">here</a>. Remember to change you password and to configure your account preferences. Hope you can enjoy our services.");
define("_BROWSEUSERS","Browse Users");
define("_SEARCHUSERS","Search Users");
define("_BROADCAST","Broadcast Public Message");
define("_BROADCASTTEXT","You can send a <i>Public Message</i> from here (255 characters max). This message will be displayed to all online users in the next 10 minutes. Any user online will see you message just once in a red bar under the site's logo. Any user can deactivate this feature from <a href=\"index.php?name=Your_Account&amp;op=edithome\">here</a>. Please don't abuse. HTML code isn't allowed here.");
define("_SEND","Send");
...
define("_ACTMSG","Your account has been activated. Please login from <a href=\"index.php?name=Your_Account\">this link</a> using your assigned Nickname and Password.");
define("_ACTERROR1","New user verification number is invalid.<br><br>Please be sure to click on the link you received by email or apply for a new account <a href=\"index.php?name=Your_Account\">here</a>.");
define("_ACTERROR2","There is no user in the database with this information.<br><br>You can register a new user from <a href=\"index.php?name=Your_Account\">here</a>.");
...
/* Recent Change for html email */
global $sitename;
define('_ACTIVATIONSUB', 'New User Account Activation for ' . $sitename);
define('_ACCOUNT_WELCOME', 'Welcome to');
define('_YOUUSEDEMAIL', 'You or someone else has used your email account');
define('_TOREGISTER', 'to register an account at');
define('_TOFINISHUSER', 'To finish the registration process you should visit an ATM in-world within the next 24 hours to activate your account, pressing ATM then using validate dialog and enter your activation code thats provided in your email otherwise the information will be automaticaly deleted by the system in the next 24 hrs.');
define('_ACTIVATION', 'At an '.$sitename.' ATM use the activate dialog and enter the following activation code:');
define('_FOLLOWINGMEM', 'Following is the member information:');

define('_FIRSTNAME', 'SL Firstname');
define('_LASTNAME', 'SL Lastname');

define('_MYFUNDS', 'My Funds');
define('_ACCOUNT_BALANCES', 'Account Balances');
define('LINDEN_DOLLAR', 'L$');
define('USD_DOLLAR', '$');
define('_VIEW_HISTORY', 'View History');
define('_DEPOSIT', 'Deposit');
define('_WITHDRAW', 'Withdraw');
define('_CREDIT_USD', 'Your account will be credited');
define('_WITHDRAW_USD', 'Withdraw USD from');
define('_WITHDRAW_USD_DISABLED', 'We\'re sorry, you cannot withdraw funds at this time.');

define('_DEPOSIT_USD', 'Deposit USD to your '.$sitename.' Account');
define('_PAYPAL_LIMITS', 'Credit Card or Standard PayPal (Limits apply - why?)');
define('_PAYPAL_AMOUNT', 'Deposit Amount');
define('_PAYPAL_DOLLARS', 'US Dollars');
define('_PAYPAL_MESSAGE', 'You can deposit $5.00 to $2,000.00 via Standard PayPal payment.');
define('_CREDIT_USAGE', 'Account credit added here must be used for the purchase of services or goods through '.$sitename.'.');
define('_ALTERNATE_PAYMENT', 'Alternate Payment Method');

define("_WITHDRAW_MSG","Your account has just withdrew");
define("_WITHDRAW_ERROR1","I believe your avatar key is invalid please contact us via www.slelite.com.");
define("_WITHDRAW_ERROR2", "There seems to be an error in sendign your funds");
?>