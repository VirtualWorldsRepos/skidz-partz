...
function PrintPage($sid) {
	global $site_logo, $site_url, $sitename, $datetime, $prefix, $db, $module_name;
	$sid = intval($sid);
	...
	echo "<html>
	    ...
	    "._THEURL."<br>
	    <a href=\"$site_url/index.php?name=$module_name&file=article&sid=$sid\">$site_url/index.php?name=$module_name&file=article&sid=$sid</a>
	    </font>
	    </td></tr></table>
	    </body>
	    </html>";
