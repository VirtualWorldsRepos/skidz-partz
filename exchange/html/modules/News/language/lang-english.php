...
define("_NOANONCOMMENTS","No Comments Allowed for Anonymous, please <a href=\"index.php?name=Your_Account&amp;op=new_user\">register</a>");
...
define('_YOURFIRSTNAME', 'Firstname');
define('_YOURLASTNAME', 'Lastname');
define('_FFRIENDFIRSTNAME', 'Your Friend\'s Firstname');
define('_FFRIENDLASTNAME', 'Your Friend\'s Lastname');
?>