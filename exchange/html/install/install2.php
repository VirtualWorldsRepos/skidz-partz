...
if (!$DBcreated){
	...
	populate_db( $database, 'exchange.sql' );
	$DBcreated = 1;
}
 ...
 */
function populate_db( &$database, $sqlfile='exchange.sql') {
	global $errors;
...
<div id="wrapper">
	<div id="header">
	  <div id="exchange"><img src="header_install.png" alt="Skidz Partz - Exchange Installation" /></div>
	</div>
</div>
...
<?php } ?>
  			...
  			<h1>Enter the name of your Skidz Partz - Exchange site:</h1>
...
<?php } else { ?>
			...
			<br/>
			<br/>
  			Type in the name for your Skidz Partz - Exchange powered site. This
...
?>
  				...
  				<tr>
  					<td width="100">&nbsp;</td>
  					<td align="center" class="small">e.g. The Home of Skidz Partz - Exchange</td>
  				</tr>
  				</table>
<?php
  			} // if
