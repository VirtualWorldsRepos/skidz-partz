...
<head>
<title>Skidz Partz - Exchange Installer</title>
...
function check() {
	...
	if ( f.siteUrl.value == '' ) {
		...
		f.adminEmail.focus();
		formValid = false;
	} else if ( f.adminFirstname.value == '' ) {
		alert('Please enter an admin firstname for your administrator firstname');
		f.adminFirstname.focus();
		formValid = false;
	} else if ( f.adminLastname.value == '' ) {
		alert('Please enter an admin lastname for your administrator lastname');
		f.adminLastname.focus();
		formValid = false;		
	...
	<div class="install">
		...
		<div id="right">
			...
			<div class="install-text">
				...
				<p>Enter The default Super User and this can be changed later from your administration panel.<br /><br />
...
?>
					...
					<tr>
						<td nowarp>Your Admin Firstname:</td>
						<td align="center"><input class="inputbox" type="text" name="adminFirstname" value="<?php echo "$adminFirstname"; ?>" size="40" /></td>
					</tr>
					<tr>
						<td nowarp>Your Admin Lastname:</td>
						<td align="center"><input class="inputbox" type="text" name="adminLastname" value="<?php echo "$adminLastname"; ?>" size="40" /></td>
					</tr>					
					<tr>
