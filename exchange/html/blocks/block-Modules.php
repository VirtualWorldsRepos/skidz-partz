...
if (file_exists("themes/$ThemeSel/module.php")) {
	...
	if ($m_title != $main_module) {
		...
		$content .= "<strong><big>&middot;</big></strong>&nbsp;<a href=\"index.php?name=$m_title\">$m_title2</a><br>\n";
	    }
	}
    }
	...
	while ($row5 = $db->sql_fetchrow($result5)) {
	    ...
	    if ($mn_title2 != "") {
		$content .= "<strong><big>&middot;</big></strong>&nbsp;<a href=\"index.php?name=$mn_title\">$mn_title2</a><br>\n";
		$dummy = 1;
	    } else {
		$a = 1;
	    }
