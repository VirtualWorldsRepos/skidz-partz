...
global $user, $cookie, $prefix, $user_prefix, $db, $sl_firstname, $sl_lastname, $sitekey, $gfx_chk, $locale;
...
while (list($uname, $guest) = $db->sql_fetchrow($result)) {
    if (isset($guest) and $guest == 0) {
        if ($i < 10) {
            $who_online_now .= "0" .$i." :&nbsp;<a href=\"index.php?name=Your_Account&amp;op=userinfo&amp;username=$uname\">$uname</a><br>\n";
        } else {
            $who_online_now .= $i.":&nbsp;<a href=\"index.php?name=Your_Account&amp;op=userinfo&amp;username=$uname\">$uname</a><br>\n";
        }
...
if (is_user($user)) {
    ...
    $content .= "<img src=\"images/blocks/group-4.gif\" height=\"14\" width=\"17\"> "._BWEL.", <b>$sl_firstname $sl_lastname</b>\n<hr>";
...
if (extension_loaded('gd') AND ($gfx_chk == 2 OR $gfx_chk == 4 OR $gfx_chk == 5 OR $gfx_chk == 7)) {
    ...
    $content .= "<input type=\"submit\" value=\""._LOGIN."\">\n (<a href=\"index.php?name=Your_Account&amp;op=new_user\">"._BREG."</a>)<hr>";
}
$content .= "<img src=\"images/blocks/group-2.gif\" height=\"14\" width=\"17\"> <b><u>"._BMEMP.":</u></b><br>\n";
$content .= "<img src=\"images/blocks/ur-moderator.gif\" height=\"14\" width=\"17\"> "._BLATEST.": <a href=\"index.php?name=Your_Account&amp;op=userinfo&amp;username=$lastuser\"><b>$lastuser</b></a><br>\n";
